...
const SAMMIMethodsCompletionHover: CompletionPlusHover[] = [
    ...
    },
    {
        label: "setVariable",
        kind: CompletionItemKind.Function,
        detail: "SAMMI.setVariable(name, value, buttonId = 'global', instanceId?)",
        documentation: {
            kind: MarkupKind.Markdown,
    ...
    },
    {
        label: "editButton",
        kind: CompletionItemKind.Function,
        detail: "SAMMI.editButton(deckId, buttonId)",
        documentation: {
            kind: MarkupKind.Markdown,
            value: "Opens an edit commands window in SAMMI for the selected button.\n\r Highly experimental.\n\r*@arg* `deckId` - deck ID where the button resides\n\r*@arg* `buttonId` - button ID to open.",
        },
    },
    {
        label: "saveIni",
        kind: CompletionItemKind.Function,
        detail: "SAMMI.saveIni(fileName, section, key, value, type = 'string' | 'number')",
        documentation: {
            kind: MarkupKind.Markdown,
            value: "Saves a value in an INI file.\n\r*@arg* `fileName` - file name\n\r*@arg* `section` - section name\n\r*@arg* `key` - key name\n\r*@arg* `value` - value to save\n\r*@arg* `type` -  type of the value, either string or number",
        },
    },
    {
        label: "loadIni",
        kind: CompletionItemKind.Function,
        detail: "SAMMI.loadIni(fileName, section, key, type = 'string' | 'number')",
        documentation: {
            kind: MarkupKind.Markdown,
            value: "Loads a value from an INI file.\n\r*@arg* `fileName` - file name\n\r*@arg* `section` - section name\n\r*@arg* `key` - key name\n\r*@arg* `type` -  type of the value, either string or number",
        },
    },
    {
        label: "openURL",
        kind: CompletionItemKind.Function,
        detail: "SAMMI.openURL(url)",
        documentation: {
            kind: MarkupKind.Markdown,
            value: "Opens an URL in your default browser.\n\rUseful when Bridge is docked in OBS to avoid opening URLs in OBS.\n\r*@arg* `url` - full URL to open",
        },
    },
    {
        label: "httpRequest",
        kind: CompletionItemKind.Function,
        detail: "SAMMI.httpRequest(url, method = 'GET', headers?, body?)",
        documentation: {
            kind: MarkupKind.Markdown,
            value: "Sends an HTTP request via SAMMI to avoid CORS issues.\n\r*@arg* `url` - full URL to send the request to\n\r*@arg* `method` - HTTP method, GET, POST, PUT, DELETE etc.\n\r*@arg* `headers` - object containing all headers\n\r*@arg* `body` - body of the request",
        },
    },
    {
        label: "popUp",
    ...
    },
    {
        ...
        documentation: {
            kind: MarkupKind.Markdown,
            value: "NOTE: This function is NO LONGER SUPPORTED and has been REMOVED from SAMMI Core.\n\rReceive or stop receiving all deck and button updates\n\r*@arg* `enabled<boolean>` - true to start, false to stop",
        },
    },
    {
